...
PROFILE_INFO_API = f"{BASE_URL}/ajax/profile/info"
PROFILE_MYMBLOG_API = f"{BASE_URL}/ajax/statuses/mymblog"
PROFILE_SEARCH_API = f"{BASE_URL}/ajax/statuses/searchProfile"
LOGIN_URL = (
